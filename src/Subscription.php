...
use Laravel\CashierConnect\Exceptions\IncompletePayment;
use Laravel\CashierConnect\Exceptions\SubscriptionUpdateFailure;
...
class Subscription extends Model
{
    ...
    {
        $user = $this->owner;
        if ($this->getStripeAccount() && $user)
            $user->setStripeAccount($this->getStripeAccount());
